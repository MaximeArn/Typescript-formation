...
a decorator factory is a function that takes argument(s) and that return a anonymous function tath is the decorator. it allow us to pass data to the decorator.
...
We can also combine method decorators and decorators factory.
